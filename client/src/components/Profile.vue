  ...
  <div>
      <section>
          ...
          <div v-if="profileData" class="container">
              <h1 class="gamertag">
                  <img v-bind:src="profileData.platformInfo.avatarUrl" class="platform-avatar">
                  {{profileData.platformInfo.platformUserId}}
              </h1>
              <div class="grid">
                  <div>
                      <img v-bind:src="profileData.segments[1].metadata.imageUrl">
                  </div>
                  <ul>
                    <li>
